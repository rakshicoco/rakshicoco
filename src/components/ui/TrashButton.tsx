...
export function TrashButton({ entityType, entityId, label }: TrashButtonProps) {
  ...
  return (
    <div>
      <button
        onClick={handleTrash}
        disabled={pending}
        className="flex items-center gap-1.5 px-3 py-2 text-xs font-semibold text-rose-600 dark:text-rose-400 rounded-xl border border-rose-200 dark:border-rose-900/60 bg-white dark:bg-slate-900 hover:bg-rose-50 dark:hover:bg-rose-950/30 active:scale-95 transition-all min-h-[40px] touch-manipulation"
