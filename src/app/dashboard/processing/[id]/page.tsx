...
import { ArrowLeft, Factory, Calendar, Users } from "lucide-react";

export default async function ProcessingBatchDetailPage({ params }: { params: { id: string } }) {
    ...
    <div className="p-4 max-w-md mx-auto space-y-5">
      <div className="flex items-center gap-2.5">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500">Processing & dehusking batch details</p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-xs space-y-4">
        <div className="grid grid-cols-2 gap-3 text-xs">
          ...
          <div>
            <span className="text-slate-400 block mb-0.5">Qty Given</span>
