  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-slate-100">Processing</h1>
      ...
      <Card>
        <CardHeader className="pb-3">
          <div className="flex items-center space-x-2">
            ...
            <Input 
              type="search" 
              placeholder="Search processing batches by ID or Purchase..." 
