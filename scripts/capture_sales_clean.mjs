...
async function run() {
  ...
  console.log('Reloading /dashboard/sales...');
  await send('Page.navigate', { url: 'https://rakshicoco.vercel.app/dashboard/sales' });
  await new Promise(r => setTimeout(r, 4000));
  execSync(`"${ADB}" -s emulator-5554 shell screencap -p /sdcard/build18_sales_clean.png`);
  execSync(`"${ADB}" -s emulator-5554 pull /sdcard/build18_sales_clean.png "${ARTIFACT_DIR}\\build18_sales_clean.png"`);
  console.log('Saved build18_sales_clean.png');
